...
def test_response():
    """Endpoint de prueba para verificar el algoritmo de response_time"""
    ...
    return {
        ...
        "min_response_time": round(min(deltas), 2) if deltas else 0,
        "max_response_time": round(max(deltas), 2) if deltas else 0
    } 